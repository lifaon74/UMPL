	...
	try {
		switch(self.execMode) {
			case self.execModes.EVAL:
				(new Function('$compiler', '$buffer', 'require', 'VString', code))(self, self.$buffer, require, VString);
			break;
			...
			break;
			case self.execModes.REQUIRE:
				var jsCode = "module.exports.run = function($compiler, $buffer, require, VString) {" + code + " };"
				fs.writeFileSync(filePath, jsCode);
				var debug = require(filePath);
				fs.unlinkSync(filePath);
				debug.run(self, self.$buffer, require, VString);
			break;
		}
