...
$buffer.push("\r\n\t\r\n\t" +  microcontroller.pinMode(ledPin, 'OUTPUT'));$buffer.push(";\r\n\t\r\n\t" +  microcontroller.analogReference('DEFAULT'));$buffer.push(";\t\r\n\t" +  microcontroller.analog10Bits());$buffer.push(";\r\n\t" +  microcontroller.analogPrescaler(4));$buffer.push(";\t\r\n\tSerial.println(" +  microcontroller.analogRead(5));$buffer.push(", DEC);\t\r\n\t\r\n\r\n\t" +  microcontroller.SPI.begin());$buffer.push("\r\n\t\r\n}\r\n\r\nvoid loop() {\r\n\t" +  microcontroller.digitalWrite(raw('LED_PIN'), raw('HIGH')));$buffer.push(";\r\n\tdelay(100);\r\n\t" +  microcontroller.digitalWrite(raw('LED_PIN'), raw('LOW')));$buffer.push(";\r\n\tdelay(100);\r\n}\r\n\r\n\r\n");
